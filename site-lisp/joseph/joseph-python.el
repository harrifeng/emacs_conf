...
;; (autoload 'helm-ipython-complete "helm-ipython")
...
(defun my-python-mode-config()
  ...
  ;; evil gd goto-definition 会调用jedi:goto-definition
  (define-key python-mode-map (kbd "M-.") 'helm-etags+-select)
  (define-key python-mode-map (kbd "M-,") 'helm-etags+-history-go-back)


  ;; (define-key python-mode-map (kbd "M-RET") 'helm-ipython-complete)
...
(provide 'joseph-python)

;; Local Variables:
;; coding: utf-8
;; End:

;;; joseph-python.el ends here
